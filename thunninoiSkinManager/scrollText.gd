...
@export var pause_duration: float = 1.5   ## Seconds to wait at each end
@export var edge_padding: float   = 0.0  ## Extra gap added at the right end
...
func _check_for_changes() -> void:
	...
	# ✅ Measure actual rendered text width, no label padding included
